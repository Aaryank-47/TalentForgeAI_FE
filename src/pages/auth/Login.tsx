...
const Login = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulate login based on selected role later, redirecting to recruiter dashboard for now
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <a
                  href="#"
                  className="inline-flex w-full justify-center rounded-lg border border-border bg-white px-4 py-2 text-sm font-medium text-slate-500 shadow-sm hover:bg-slate-50"
                >
