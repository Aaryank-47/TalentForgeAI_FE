            ...
            {navbarContent.navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.label}
                  to={item.href}
                  className={`flex items-center gap-1.5 text-[14px] font-medium px-4 py-2 rounded-lg transition-colors ${
                    isActive 
              ...
              return (
                <Link 
                  ...
                  className={`text-[15px] font-medium px-4 py-3 rounded-lg ${
                    isActive ? 'bg-slate-50 text-[#2563EB]' : 'text-slate-600 hover:bg-slate-50'
                  }`}
